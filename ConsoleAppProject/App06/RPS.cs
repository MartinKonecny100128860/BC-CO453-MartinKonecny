...
{
    /// <summary>
    /// This app will ask the user to enter the number of miles (fromUnit) and convert it to feet or
    ...
    internal class RPS
    {
        ...
        private static void PlayGame()
        {
            ...
            Console.WriteLine("R-P-S Console Game!");
            ...
            while (yourScore != 3 && npcScore != 3)
            {
                ...
                // Prompts the user to enter a letter for selection of rock, paper, and scissors
